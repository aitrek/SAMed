...
def trainer_synapse(args, model, snapshot_path, multimask_output, low_res):
    global global_step
    from datasets.dataset_synapse import Synapse_dataset, RandomGenerator, MyDataset
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in tqdm(enumerate(trainloader), total=len(trainloader),
            ...
            # low_res_label_batch = low_res_label_batch
            ...
            if global_step % save_interval == 0:
                ...
                if avg_loss < best_avg_loss:
                    ...
                    save_mode_path = os.path.join(snapshot_path, f"epoch_{epoch_num}_loss_{best_avg_loss}" + '.pth')
                    try:
